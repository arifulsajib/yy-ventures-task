    ...
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
        <div className="ps-0 text-center lg:text-start lg:ps-[132px] order-2 lg:order-1">
          ...
          <h1 className="text-4xl lg:text-6xl text-deepblue-color font-bold">Best Learning </h1>
          <h1 className="text-4xl lg:text-6xl text-deepblue-color font-bold my-3 mb-5">Opportunities</h1>
